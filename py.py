class BookingSystem:
    ...
    def __init__(self, status):
        ...
        def booking_statistic():
            ...
            # Example usage
            bookings = [
                BookingSystem('submitted'),
                BookingSystem('approved'),
                BookingSystem('pending'),
                BookingSystem('not approved'),
                BookingSystem('approved')
                ]

            counts = booking_statistic(bookings)
            print(counts)
            booking_statistic()
